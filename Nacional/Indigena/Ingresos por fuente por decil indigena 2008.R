############################################################################
###########  Ingresos por fuente por decil indigena  #####################
#########################################################################
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/ENIGH2008/Nacional/Indigena")

write.dbf(c_DECIL_ES,file = "Nacional Ingresos por fuente por DECIL estimaciones 2008 indigena.dbf")
write.dbf(c_DECIL_SE,file = "Nacional Ingresos por fuente por DECIL errores standard 2008 indigena.dbf")
write.dbf(c_DECIL_CV,file = "Nacional Ingresos por fuente por DECIL CV 2008 indigena.dbf")
write.dbf(c_DECIL_LI,file = "Nacional Ingresos por fuente por DECIL LI 2008 indigena.dbf")
write.dbf(c_DECIL_ES,file = "Nacional Ingresos por fuente por DECIL LS 2008 indigena.dbf")
